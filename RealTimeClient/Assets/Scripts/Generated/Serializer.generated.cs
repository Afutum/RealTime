...
namespace MessagePack.Resolvers
{
    ...
    internal static class GeneratedResolverGetFormatterHelper
    {
        ...
        static GeneratedResolverGetFormatterHelper()
        {
            ...
            {
                { typeof(global::RialTimeServer.Model.Entity.User), 0 },
        ...
        internal static object GetFormatter(global::System.Type t)
        {
            ...
            switch (key)
            {
                case 0: return new MessagePack.Formatters.RialTimeServer.Model.Entity.UserFormatter();
...
namespace MessagePack.Formatters.RialTimeServer.Model.Entity
{
    public sealed class UserFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::RialTimeServer.Model.Entity.User>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::RialTimeServer.Model.Entity.User value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
        ...
        public global::RialTimeServer.Model.Entity.User Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::RialTimeServer.Model.Entity.User();
...
namespace MessagePack.Formatters.Shared.Interfaces.StreamingHubs
{
    public sealed class JoinedUserFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Interfaces.StreamingHubs.JoinedUser>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Interfaces.StreamingHubs.JoinedUser value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::RialTimeServer.Model.Entity.User>(formatterResolver).Serialize(ref writer, value.UserData, options);
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        ____result.UserData = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::RialTimeServer.Model.Entity.User>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    case 2:
